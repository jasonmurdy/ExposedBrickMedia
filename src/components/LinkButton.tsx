...
export const LinkButton = ({ link, className: passedClassName }: { link: any, className?: string }) => {
  ...
  const defaultClassName = "inline-block px-6 py-3 bg-brick-copper hover:bg-white text-charcoal font-bold uppercase text-[10px] tracking-widest transition-colors duration-300";
