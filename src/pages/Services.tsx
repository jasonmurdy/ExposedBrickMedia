...
export default function ServicesPage() {
  return (
    <div className="flex flex-col w-full min-h-screen">
      <Helmet>
        <title>Services Offered | Exposed Brick Media</title>
        <meta name="description" content="Cinematic videography, high-fidelity photography, and architectural storytelling services." />
      </Helmet>
